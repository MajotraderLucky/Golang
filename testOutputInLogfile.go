...
func main() {
	...
	// Цикл for, который приведён ниже, успешно работает. Но для того,
	// чтобы посчитать количество итераций, необходимо посчитать
	// сначала количество пробелов в строковой переменной файла testLog.log

	//-------------------Блок с поиском пробелов в переменной--------------
	ipList, err = ioutil.ReadFile("testLog.log")
